...
public class AddonOperationsImpl implements AddonOperations {
    ...
    public void setup() {
        ...
        projectOperations.addRepository("", new Repository("Addon Roo add-on repository", "Addon Roo add-on repository", "https://taddon.googlecode.com/svn/repo"));
        
        List<Dependency> dependencies = new ArrayList<Dependency>();
        
        // Install the dependency on the add-on jar (
        dependencies.add(new Dependency("net.mfjassociates.addon", "net.mfjassociates.addon", "0.1.0.BUILD-SNAPSHOT", DependencyType.JAR, DependencyScope.PROVIDED));
